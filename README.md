...
* 2019.11.18修改：Root用户可以强制将手机分辨率调整适配车机屏幕，不肯Root的同学就不用再提了<br>


Root的设备可以通过如下命令修改手机分辨率适配车机比例<br>
1.adb shell<br>
2.su<br>
3.wm size 宽x高  比如:wm size 1080x1920 适配16/9比例车机<br>
4.wm size reset可以重置为手机默认比例，万一退出发现没有恢复默认分辨率也可以通过这个命令恢复<br>
